...
class segment_Tree 
{
    ...
    void __init( vector<int>&T , vector<int>&A , int v , int ss , int se )
    {
        int l = 2*v + 1 ;
        int r = 2*v + 2 ;
        int L = se-ss+1 ;
    ...
    void put( int v , int ss , int se , int qs , int qe , int val )
    {
        int l = 2*v + 1 ;
        int r = 2*v + 2 ;
        int L = se-ss+1 ;
        ...
        put( l , ss , mid , qs , qe , val );
        put( r , mid+1, se , qs ,qe , val );
    ...
    void add( int v , int ss , int se , int qs , int qe , int val )
    {
        int l = 2*v + 1 ;
        int r = 2*v + 2 ;
        int L = se-ss+1 ;
        ...
        add( l , ss , mid , qs , qe , val );
        add( r , mid+1,se , qs , qe , val );
    ...
    int sum( int a , int b )
    {
         return sum( 0 , 0 , N-1 , a , b );
    }

    int sum( int v , int ss , int se , int qs , int qe )
    {
        int l = 2*v + 1 ;
        int r = 2*v + 2 ;
        int L = se-ss+1 ;
        ...
        auto lt = sum( l , ss , mid , qs , qe );
        auto rt = sum( r , mid+1, se, qs , qe );
...
//--------------------------------template ends here ----------------------------------//
      ...
      void dfs( vector<int>t[] , vector<int>&A , vector<int>&B , vector<int>&W , int u , int p )
      {
         int N = A.size();
