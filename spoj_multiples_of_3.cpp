...
/********************______Fenwick Tree______******************************/
      ...
      // class name - FT_update_type|query_type 
...
//--------------------------------template ends here ----------------------------------//
       ...
       void __init( vector< vector<int> >&T , int v , int ss , int se )
       {
           if( ss == se )
           {
              T[v] = { 1 , 0 , 0 };
       ...
       void add( vector<vector<int>>&T , vector<int>&Lazy , int v , int ss , int se , int qs , int qe )
       {
           int l = 2*v+1;
           int r = 2*v+2;
           int L = se-ss+1;
           ...
           if( Lazy[v] != 0 )
           {
               rotate( T[v].begin() , T[v].begin()+Lazy[v] , T[v].end() );
           ...
           if( qs <= ss && se <= qe )
           {
              rotate( T[v].begin() , T[v].begin()+1 , T[v].end() ) ;
           ...
           add( T , Lazy , l , ss , mid , qs , qe );
           add( T , Lazy , r , mid+1 , se , qs , qe );

           T[v] = combine( T[l] , T[r] );
       }  

       vector<int> sum( vector<vector<int>>&T , vector<int>&Lazy , int v , int ss , int se , int qs , int qe )
       {
           vector< int > res( 3, 0 );
           ...
           auto lt = sum( T , Lazy , l , ss , mid , qs , qe );
           auto rt = sum( T , Lazy , r , mid+1, se , qs , qe);
       ...
       void go()
       {
          ...
          vector<vector<int>> T( 4*N , vector<int>( 3 , 0 ) );
          ...
          while(Q--)
          {
              ...
              if( t == 0 )
              {
                  add( T , Lazy , 0 , 0 , N-1 , a , b );   
              }
              else
              {
                 auto x = sum( T , Lazy , 0 , 0 , N-1 , a , b );
                 cout<<x[0]<<endl;
              }
          }
