...
//--------------------------------template ends here ----------------------------------//
      ...
      void __init( vector<int>&T , vector<int>&Lazy , vector<int>&A , int v , int ss , int se )
      {
         int l = 2*v + 1 ;
         int r = 2*v + 2 ;
         int L = se-ss+1 ;
         ...
         __init( T , Lazy , A , l , ss , mid );
         __init( T , Lazy , A , r , mid+1, se );

         T[v] = T[l] + T[r] ;
      }

      void add( vector<int>&T , vector<int>&Lazy, int v , int ss , int se , int qs , int qe , int x )
      {
         int l = 2*v + 1 ;
         int r = 2*v + 2 ;
         int L = se-ss+1 ;
         ...
         add( T , Lazy , l , ss , mid , qs , qe , x );
         add( T , Lazy , r , mid+1,se, qs , qe , x );

         T[v] = T[l] + T[r] ;
      }
          

       int sum( vector<int>&T , vector<int>&Lazy , int v , int ss , int se , int qs , int qe )
       {
          int l = 2*v + 1 ;
          int r = 2*v + 2 ;
          int L = se-ss+1 ;
          ...
          int lt = sum( T , Lazy , l , ss , mid , qs , qe );
          int rt = sum( T , Lazy , r , mid+1,se , qs , qe );
       ...
       void go( )
       {
          ...
          for( int i = 0 ; i < M ; i++ )
          {
             ...
             add( T , Lazy , 0 , 0 , N-1 , a , b , L*c );
          }

          // nl;

          for( int i = 0 ; i < N ; i++ )
          cout<<sum( T , Lazy , 0 , 0 , N-1 , i , i )<<" ";
